...
namespace xul.Controllers.Logic
{
    public class ParentController : Controller
    {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,FirstName,MiddleName,LastName,DateOfBirth,Gender,MaritalStatus,CreatedBy,CreatedDate,EditedBy,EditedDate")] Parent parent)
        {
            if (ModelState.IsValid)
            {
